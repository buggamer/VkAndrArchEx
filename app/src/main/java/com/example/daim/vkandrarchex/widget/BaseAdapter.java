package com.example.daim.vkandrarchex.widget;
...
public abstract class BaseAdapter<VH extends RecyclerView.ViewHolder, T> extends RecyclerView.Adapter<VH> {
    ...
    private final static String LOG_TAG = "BaseAdapter";
    ...
    public final void setData(@NonNull List<T> values){
        mItems = values;
    }

    public void refreshRecycler() {
        Log.d(LOG_TAG, "items.size(): " + mItems.size());
